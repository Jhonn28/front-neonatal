...
@Component({
  selector: 'ind-nueve-c',
  templateUrl: './nueve-c.component.html',
})
export class NueveCComponent extends BarMenu implements AfterViewInit {
  ...
  async ngAfterViewInit(): Promise<void> {
    await this.tabTable1.setTable('ind_complicacion_neonatal_c', 'ide_indcnc', 1);
    this.tabTable1.setTitle('indicadores complicación neonatal c');
    this.tabTable1.getColumn('detalle_indcnc').setVisualName('indicador');
    this.tabTable1.getColumn('detalle_indcnc').setRequired(true);
