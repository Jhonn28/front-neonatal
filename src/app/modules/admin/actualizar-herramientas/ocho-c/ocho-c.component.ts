...
export class OchoCComponent implements OnInit {
  ...
  async saveData(event) {
    ...
    this.datosIndicador.forEach(element => {
      ...
      delete body[index].ide_indcoc;
      delete body[index].nro_historia_clinica_hcoc;
      body[index]['ide_hcoc'] = +element.ide_hcoc;
      index++;
    });
    ...
    await this._indicadorService.updateData(data, 'her_encabezado_general', 'ide_heg', 'her_complicacion_obstetrica_c', 'ide_hcoc', 'ide_indcoc').subscribe(async (res: any) => {
